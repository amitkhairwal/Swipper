...
import {  FaTelegramPlane, FaTwitterSquare, FaYoutube } from "react-icons/fa";
import { FaSquareInstagram } from "react-icons/fa6";


export default function Home() {
  const [textStroke, setTextStroke] = useState("4px black"); // Default for desktop

  useEffect(() => {
    // Check if it's mobile screen size when component is mounted
    ...
    <div className="flex flex-col items-center text-center md:items-start md:text-left space-y-4 md:space-y-0">
      <div className="flex flex-col md:flex-row md:items-center lg:gap-72">
        ...
        <div>
          ...
          {/* Fox Image aligned to the right for desktop, centered for mobile */}
